...
init python:
    ...
    gallery_items = [
        ...
        {"name": "Ingunn Bøe Hartmann", "title": "Fish Enthusiast", "desc": "Knows too much about trout.", "images": ["ingunn_one", "ingunn_two"]},
...
screen character_gallery():
    ...
    viewport id "gallery_vp": 
        ...
        vbox:
                ...
                for item in gallery_items:
                    ...
                    button:
                        ...
                        vbox:
                            ...
                            text item["name"] size 22 color "#ffffff" outlines [(1, "#000")] xalign 0.5 yalign 0.5
            ...
            # Dette tomrommet under griden skyver innholdet opp når du ruller helt ned
            null height 70

    # Description Frame (Fikset posisjonskrasj ved å separere xsize og ysize)
    frame:
        xalign 0.5 
        ypos 1.0 
        yanchor 1.0
