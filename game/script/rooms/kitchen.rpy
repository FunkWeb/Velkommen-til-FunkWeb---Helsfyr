label kitchen:
    scene expression Transform("images/rooms/kitchen_overview.webp", fit="cover", align=(0.5, 0.5)) with fade
    ...
    scene expression Transform("images/rooms/kitchen_fridge.webp", fit="cover", align=(0.5, 0.5)) with fade
