...
## About the game
**Velkommen til FunkWeb – Helsfyr** is an interactive game developed in Ren'Py to give people an easy and engaging introduction to the new locale for FunkWeb at Helsfyr.
...
- Processor: 2.0 GHz 64/bit Intel-compatible,  Apple M1 or newer  
- RAM: 2.0 GB  
- Graphics: OpenGL 3.0 
...
- Python 3.12 – logic and scripting

### Development tools
- Visual Studio Code 1.113.0 – main editor  
- Git & GitHub – version control  
- GitHub Issues – error reporting and task management
- Asana – project planning and coordination  

### Graphics and media
- iPhone / Android camera – pictures of employees and locales
- Photoshop 2025 – image processing and optimisation  
- Image compression and WebP conversion - for improved performance  
- Studio LED-lights – even lighting and imrpoved image quality
